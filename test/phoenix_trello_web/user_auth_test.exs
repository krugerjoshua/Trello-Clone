defmodule PhoenixTrelloWeb.UserAuthTest do
  use PhoenixTrelloWeb.ConnCase, async: true

  alias PhoenixTrello.Accounts
  alias PhoenixTrello.Accounts.Scope
  alias PhoenixTrelloWeb.UserAuth

  import PhoenixTrello.AccountsFixtures

  @remember_me_cookie "_phoenix_trello_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhoenixTrelloWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
